...
for n in range(step_num):
    ...
    w1 = 1 / sonar1_sen.var_estimator() / (1 / sonar1_sen.var_estimator() + 1 / ir3_sen.var_estimator_at_x0(mean_x_posterior) + 1 / ir4_sen.var_estimator_at_x0(mean_x_posterior))
    w2 = 1 / ir3_sen.var_estimator_at_x0(mean_x_posterior) / (1 / sonar1_sen.var_estimator() + 1 / ir3_sen.var_estimator_at_x0(mean_x_posterior) + 1 / ir4_sen.var_estimator_at_x0(mean_x_posterior))
    w3 = 1 / ir4_sen.var_estimator_at_x0(mean_x_posterior) / (1 / sonar1_sen.var_estimator() + 1 / ir3_sen.var_estimator_at_x0(mean_x_posterior) + 1 / ir4_sen.var_estimator_at_x0(mean_x_posterior))
