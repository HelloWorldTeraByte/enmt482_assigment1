...
class IR3SensorModel(object):
    def __init__(self, distance, measurement, polynomial_order=3, segment_point1=0.6, smooth=100):
    ...
    def plots_init(self):
        ...
        self.smooth_slider = Slider(self.ir3_ax_smoothing, 'Smoothin', 1, 200, self.smooth_val)
...
ir3_sen = IR3SensorModel(distance, raw_ir2)
plt.show()
